...
let%expect_test "function - identity" =
  ...
  [%expect
    {|
    Variables: a21732,a21732
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Variable: a21732
          └──Type expr: Variable: a21732
       └──Desc: Function
          └──Pattern:
             └──Type expr: Variable: a21732
  ...
  [%expect
    ...
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Arrow
             └──Type expr: Tuple
                └──Type expr: Variable: a21751
                └──Type expr: Variable: a21752
             └──Type expr: Variable: a21745
          └──Type expr: Arrow
             └──Type expr: Variable: a21751
             └──Type expr: Arrow
                └──Type expr: Variable: a21752
...
let%expect_test "function - uncurry" =
  ...
  [%expect
    {|
    Variables: a21761,a21771,a21768,a21768,a21771
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Arrow
             └──Type expr: Variable: a21771
             └──Type expr: Arrow
                └──Type expr: Variable: a21768
                └──Type expr: Variable: a21761
          └──Type expr: Arrow
             └──Type expr: Tuple
                └──Type expr: Variable: a21771
                └──Type expr: Variable: a21768
...
let%expect_test "function - compose" =
  ...
  [%expect
    ...
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Arrow
             └──Type expr: Variable: a21787
             └──Type expr: Variable: a21784
          └──Type expr: Arrow
             └──Type expr: Arrow
                └──Type expr: Variable: a21790
                └──Type expr: Variable: a21787
             └──Type expr: Arrow
                └──Type expr: Variable: a21790
                └──Type expr: Variable: a21784
...
let%expect_test "function - fst" =
  ...
  [%expect
    {|
    Variables: a21798,a21795,a21795
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Tuple
             └──Type expr: Variable: a21795
             └──Type expr: Variable: a21798
          └──Type expr: Variable: a21795
       └──Desc: Function
          └──Pattern:
             └──Type expr: Tuple
...
let%expect_test "function - snd" =
  ...
  [%expect
    {|
    Variables: a21804,a21808,a21804
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Tuple
             └──Type expr: Variable: a21808
             └──Type expr: Variable: a21804
          └──Type expr: Variable: a21804
       └──Desc: Function
          └──Pattern:
             └──Type expr: Tuple
...
let%expect_test "function - hd" =
  ...
  [%expect
    {|
    Variables: a21813,a21813
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Constructor: list
             └──Type expr: Variable: a21816
          └──Type expr: Variable: a21813
       └──Desc: Function
          └──Pattern:
             └──Type expr: Constructor: list
                └──Type expr: Variable: a21816
...
let%expect_test "annotation - identity" =
  ...
  [%expect
    {|
    Variables: a21831,a21831,a21831
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Variable: a21831
          └──Type expr: Variable: a21831
       └──Desc: Function
          └──Pattern:
             └──Type expr: Variable: a21831
...
let%expect_test "annotation - identity" =
  ...
  [%expect
    ...
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Variable: a21845
          └──Type expr: Variable: a21845
       └──Desc: Function
          └──Pattern:
             └──Type expr: Variable: a21840
             └──Desc: Variable: x
          └──Expression:
             └──Type expr: Variable: a21840
             └──Desc: Variable
       ...
       └──Desc: Let
          └──Value bindings:
             └──Value binding:
                └──Pattern:
                   └──Type expr: Arrow
                      └──Type expr: Variable: a21898
                      └──Type expr: Variable: a21898
                   └──Desc: Variable: id
                └──Abstraction:
                   └──Variables: a21898,a21898
                   └──Expression:
                      └──Type expr: Arrow
                         └──Type expr: Variable: a21898
                         └──Type expr: Variable: a21898
       ...
       └──Desc: Let rec
          └──Value bindings:
             └──Value binding:
                └──Variable: map
                └──Abstraction:
                   └──Variables: a21941,a21952
                   └──Expression:
                      └──Type expr: Arrow
                         └──Type expr: Arrow
                            └──Type expr: Variable: a21952
                            └──Type expr: Variable: a21941
                         └──Type expr: Arrow
                            └──Type expr: Constructor: list
                               └──Type expr: Variable: a21952
                            └──Type expr: Constructor: list
          ...
          └──Value bindings:
             └──Value binding:
                └──Pattern:
                   └──Type expr: Arrow
                      └──Type expr: Constructor: eq
                         └──Type expr: Variable: a22436
                         └──Type expr: Variable: a22437
                      └──Type expr: Arrow
          ...
          └──Value bindings:
             └──Value binding:
                └──Pattern:
                   └──Type expr: Arrow
                      └──Type expr: Tuple
                         └──Type expr: Variable: a22523
                         └──Type expr: Variable: a22526
                      └──Type expr: Variable: a22523
                   └──Desc: Variable: fst
                └──Abstraction:
                   └──Variables: a22526,a22523,a22523
                   └──Expression:
                      └──Type expr: Arrow
                         └──Type expr: Tuple
                            └──Type expr: Variable: a22523
                ...
                └──Value bindings:
                   └──Value binding:
                      └──Pattern:
                         └──Type expr: Arrow
                            └──Type expr: Tuple
                               └──Type expr: Variable: a22536
                               └──Type expr: Variable: a22532
                            └──Type expr: Variable: a22532
                         └──Desc: Variable: snd
                      └──Abstraction:
                         └──Variables: a22532,a22536,a22532
                         └──Expression:
                            └──Type expr: Arrow
                               └──Type expr: Tuple
                                  └──Type expr: Variable: a22536
                                                    ...
                                                    └──Desc: Construct
                                                       └──Constructor description:
                                                          ...
                                                          └──Constructor argument type:
                                                             └──Type expr: Tuple
                                                                └──Type expr: Constructor: term
                                                                   └──Type expr: Variable: a22688
                                                                └──Type expr: Constructor: term
                                                                   └──Type expr: Variable: a22686
                                                          └──Constructor type:
                                                             └──Type expr: Constructor: term
                                                                └──Type expr: Variable: a22560
                                                       └──Pattern:
                                                    ...
                                                    └──Desc: Construct
                                                       └──Constructor description:
                                                          ...
                                                          └──Constructor argument type:
                                                             └──Type expr: Constructor: term
                                                                └──Type expr: Tuple
                                                                   └──Type expr: Variable: a22762
                                                                   └──Type expr: Variable: a22763
                                                          └──Constructor type:
                                                             └──Type expr: Constructor: term
                                                                └──Type expr: Variable: a22560
                                                       └──Pattern:
