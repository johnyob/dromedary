...
let%expect_test "function - identity" =
  ...
  [%expect
    {|
    Variables: 22868,22868
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Variable: 22868
          └──Type expr: Variable: 22868
       └──Desc: Function
          └──Pattern:
             └──Type expr: Variable: 22868
  ...
  [%expect
    ...
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Arrow
             └──Type expr: Tuple
                └──Type expr: Variable: 22887
                └──Type expr: Variable: 22888
             └──Type expr: Variable: 22881
          └──Type expr: Arrow
             └──Type expr: Variable: 22887
             └──Type expr: Arrow
                └──Type expr: Variable: 22888
...
let%expect_test "function - uncurry" =
  ...
  [%expect
    {|
    Variables: 22897,22907,22904,22904,22907
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Arrow
             └──Type expr: Variable: 22907
             └──Type expr: Arrow
                └──Type expr: Variable: 22904
                └──Type expr: Variable: 22897
          └──Type expr: Arrow
             └──Type expr: Tuple
                └──Type expr: Variable: 22907
                └──Type expr: Variable: 22904
...
let%expect_test "function - compose" =
  ...
  [%expect
    ...
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Arrow
             └──Type expr: Variable: 22923
             └──Type expr: Variable: 22920
          └──Type expr: Arrow
             └──Type expr: Arrow
                └──Type expr: Variable: 22926
                └──Type expr: Variable: 22923
             └──Type expr: Arrow
                └──Type expr: Variable: 22926
                └──Type expr: Variable: 22920
...
let%expect_test "function - fst" =
  ...
  [%expect
    {|
    Variables: 22934,22931,22931
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Tuple
             └──Type expr: Variable: 22931
             └──Type expr: Variable: 22934
          └──Type expr: Variable: 22931
       └──Desc: Function
          └──Pattern:
             └──Type expr: Tuple
...
let%expect_test "function - snd" =
  ...
  [%expect
    {|
    Variables: 22940,22944,22940
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Tuple
             └──Type expr: Variable: 22944
             └──Type expr: Variable: 22940
          └──Type expr: Variable: 22940
       └──Desc: Function
          └──Pattern:
             └──Type expr: Tuple
...
let%expect_test "function - hd" =
  ...
  [%expect
    {|
    Variables: 22952,22952
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Constructor: list
             └──Type expr: Variable: 22955
          └──Type expr: Variable: 22952
       └──Desc: Function
          └──Pattern:
             └──Type expr: Constructor: list
                └──Type expr: Variable: 22955
...
let%expect_test "annotation - identity" =
  ...
  [%expect
    {|
    Variables: 22970,22970,22970
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Variable: 22970
          └──Type expr: Variable: 22970
       └──Desc: Function
          └──Pattern:
             └──Type expr: Variable: 22970
...
let%expect_test "annotation - identity" =
  ...
  [%expect
    ...
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Variable: 22984
          └──Type expr: Variable: 22984
       └──Desc: Function
          └──Pattern:
             └──Type expr: Variable: 22979
             └──Desc: Variable: x
          └──Expression:
             └──Type expr: Variable: 22979
             └──Desc: Variable
...
let%expect_test "annotation - succ" =
  ...
  [%expect
    {|
    ("Cannot unify types"
     ("Type_expr.decode type_expr1" (Type 23020 (Former (Constr () int))))
     ("Type_expr.decode type_expr2" (Type 23033 (Var 23033)))) |}]
       ...
       └──Desc: Let
          └──Value bindings:
             └──Value binding:
                └──Pattern:
                   └──Type expr: Arrow
                      └──Type expr: Variable: 23037
                      └──Type expr: Variable: 23037
                   └──Desc: Variable: id
                └──Abstraction:
                   └──Variables: 23037,23037
                   └──Expression:
                      └──Type expr: Arrow
                         └──Type expr: Variable: 23037
                         └──Type expr: Variable: 23037
       ...
       └──Desc: Let rec
          └──Value bindings:
             └──Value binding:
                └──Variable: map
                └──Abstraction:
                   └──Variables: 23083,23094
                   └──Expression:
                      └──Type expr: Arrow
                         └──Type expr: Arrow
                            └──Type expr: Variable: 23094
                            └──Type expr: Variable: 23083
                         └──Type expr: Arrow
                            └──Type expr: Constructor: list
                               └──Type expr: Variable: 23094
                            └──Type expr: Constructor: list
          ...
          └──Value bindings:
             └──Value binding:
                └──Pattern:
                   └──Type expr: Arrow
                      └──Type expr: Constructor: eq
                         └──Type expr: Variable: 23602
                         └──Type expr: Variable: 23603
                      └──Type expr: Arrow
          ...
          └──Value bindings:
             └──Value binding:
                └──Pattern:
                   └──Type expr: Arrow
                      └──Type expr: Tuple
                         └──Type expr: Variable: 23708
                         └──Type expr: Variable: 23711
                      └──Type expr: Variable: 23708
                   └──Desc: Variable: fst
                └──Abstraction:
                   └──Variables: 23711,23708,23708
                   └──Expression:
                      └──Type expr: Arrow
                         └──Type expr: Tuple
                            └──Type expr: Variable: 23708
                ...
                └──Value bindings:
                   └──Value binding:
                      └──Pattern:
                         └──Type expr: Arrow
                            └──Type expr: Tuple
                               └──Type expr: Variable: 23721
                               └──Type expr: Variable: 23717
                            └──Type expr: Variable: 23717
                         └──Desc: Variable: snd
                      └──Abstraction:
                         └──Variables: 23717,23721,23717
                         └──Expression:
                            └──Type expr: Arrow
                               └──Type expr: Tuple
                                  └──Type expr: Variable: 23721
                                                    ...
                                                    └──Desc: Construct
                                                       └──Constructor description:
                                                          ...
                                                          └──Constructor argument type:
                                                             └──Type expr: Tuple
                                                                └──Type expr: Constructor: term
                                                                   └──Type expr: Variable: 23873
                                                                └──Type expr: Constructor: term
                                                                   └──Type expr: Variable: 23871
                                                          └──Constructor type:
                                                             └──Type expr: Constructor: term
                                                                └──Type expr: Variable: 23745
                                                       └──Pattern:
                                                    ...
                                                    └──Desc: Construct
                                                       └──Constructor description:
                                                          ...
                                                          └──Constructor argument type:
                                                             └──Type expr: Constructor: term
                                                                └──Type expr: Tuple
                                                                   └──Type expr: Variable: 23913
                                                                   └──Type expr: Variable: 23914
                                                          └──Constructor type:
                                                             └──Type expr: Constructor: term
                                                                └──Type expr: Variable: 23745
                                                       └──Pattern:
                                                    ...
                                                    └──Desc: Construct
                                                       └──Constructor description:
                                                          ...
                                                          └──Constructor argument type:
                                                             └──Type expr: Constructor: term
                                                                └──Type expr: Tuple
                                                                   └──Type expr: Variable: 23947
                                                                   └──Type expr: Variable: 23948
                                                          └──Constructor type:
                                                             └──Type expr: Constructor: term
                                                                └──Type expr: Variable: 23745
                                                       └──Pattern:
