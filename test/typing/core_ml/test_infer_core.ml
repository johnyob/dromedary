...
let%expect_test "function - identity" =
  ...
  [%expect
    {|
    Variables: a11016,a11016
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Variable: a11016
          └──Type expr: Variable: a11016
       └──Desc: Function
          └──Pattern:
             └──Type expr: Variable: a11016
  ...
  [%expect
    ...
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Arrow
             └──Type expr: Tuple
                └──Type expr: Variable: a11035
                └──Type expr: Variable: a11036
...
let%expect_test "function - uncurry" =
  ...
  [%expect
    {|
    Variables: a11045,a11055,a11052,a11052,a11055
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Arrow
             └──Type expr: Variable: a11055
             └──Type expr: Arrow
                └──Type expr: Variable: a11052
                └──Type expr: Variable: a11045
          └──Type expr: Arrow
             └──Type expr: Tuple
                └──Type expr: Variable: a11055
                └──Type expr: Variable: a11052
...
let%expect_test "function - compose" =
  ...
  [%expect
    ...
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Arrow
             └──Type expr: Variable: a11071
             └──Type expr: Variable: a11068
          └──Type expr: Arrow
             └──Type expr: Arrow
                └──Type expr: Variable: a11074
                └──Type expr: Variable: a11071
             └──Type expr: Arrow
                └──Type expr: Variable: a11074
                └──Type expr: Variable: a11068
...
let%expect_test "function - fst" =
  ...
  [%expect
    {|
    Variables: a11082,a11079,a11079
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Tuple
             └──Type expr: Variable: a11079
             └──Type expr: Variable: a11082
          └──Type expr: Variable: a11079
       └──Desc: Function
          └──Pattern:
             └──Type expr: Tuple
...
let%expect_test "function - snd" =
  ...
  [%expect
    {|
    Variables: a11088,a11092,a11088
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Tuple
             └──Type expr: Variable: a11092
             └──Type expr: Variable: a11088
          └──Type expr: Variable: a11088
       └──Desc: Function
          └──Pattern:
             └──Type expr: Tuple
...
let%expect_test "function - hd" =
  ...
  [%expect
    {|
    Variables: a11097,a11097
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Constructor: list
             └──Type expr: Variable: a11100
          └──Type expr: Variable: a11097
       └──Desc: Function
          └──Pattern:
             └──Type expr: Constructor: list
                └──Type expr: Variable: a11100
...
let%expect_test "annotation - identity" =
  ...
  [%expect
    {|
    Variables: a11115,a11115,a11115
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Variable: a11115
          └──Type expr: Variable: a11115
       └──Desc: Function
          └──Pattern:
             └──Type expr: Variable: a11115
...
let%expect_test "annotation - identity" =
  ...
  [%expect
    ...
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Variable: a11129
          └──Type expr: Variable: a11129
       └──Desc: Function
          └──Pattern:
             └──Type expr: Variable: a11124
             └──Desc: Variable: x
          └──Expression:
             └──Type expr: Variable: a11124
             └──Desc: Variable
       ...
       └──Desc: Let
          └──Value bindings:
             └──Value binding:
                └──Pattern:
                   └──Type expr: Arrow
                      └──Type expr: Variable: a11182
                      └──Type expr: Variable: a11182
                   └──Desc: Variable: id
                └──Abstraction:
                   └──Variables: a11182,a11182
                   └──Expression:
                      └──Type expr: Arrow
                         └──Type expr: Variable: a11182
                         └──Type expr: Variable: a11182
       ...
       └──Desc: Let rec
          └──Value bindings:
             └──Value binding:
                └──Variable: map
                └──Abstraction:
                   └──Variables: a11225,a11236
                   └──Expression:
                      └──Type expr: Arrow
                         └──Type expr: Arrow
                            └──Type expr: Variable: a11236
                            └──Type expr: Variable: a11225
                         └──Type expr: Arrow
                            └──Type expr: Constructor: list
                               └──Type expr: Variable: a11236
                            └──Type expr: Constructor: list
          ...
          └──Value bindings:
             └──Value binding:
                └──Pattern:
                   └──Type expr: Arrow
                      └──Type expr: Constructor: eq
                         └──Type expr: Variable: a11720
                         └──Type expr: Variable: a11721
                      └──Type expr: Arrow
          ...
          └──Value bindings:
             └──Value binding:
                └──Pattern:
                   └──Type expr: Arrow
                      └──Type expr: Tuple
                         └──Type expr: Variable: a11807
                         └──Type expr: Variable: a11810
                      └──Type expr: Variable: a11807
                   └──Desc: Variable: fst
                └──Abstraction:
                   └──Variables: a11810,a11807,a11807
                   └──Expression:
                      └──Type expr: Arrow
                         └──Type expr: Tuple
                            └──Type expr: Variable: a11807
                ...
                └──Value bindings:
                   └──Value binding:
                      └──Pattern:
                         └──Type expr: Arrow
                            └──Type expr: Tuple
                               └──Type expr: Variable: a11820
                               └──Type expr: Variable: a11816
                            └──Type expr: Variable: a11816
                         └──Desc: Variable: snd
                      └──Abstraction:
                         └──Variables: a11816,a11820,a11816
                         └──Expression:
                            └──Type expr: Arrow
                               └──Type expr: Tuple
                                  └──Type expr: Variable: a11820
                                                    ...
                                                    └──Desc: Construct
                                                       └──Constructor description:
                                                          ...
                                                          └──Constructor argument type:
                                                             └──Type expr: Tuple
                                                                └──Type expr: Constructor: term
                                                                   └──Type expr: Variable: a11972
                                                                └──Type expr: Constructor: term
                                                                   └──Type expr: Variable: a11970
                                                          └──Constructor type:
                                                             └──Type expr: Constructor: term
                                                                └──Type expr: Variable: a11844
                                                       └──Pattern:
                                                    ...
                                                    └──Desc: Construct
                                                       └──Constructor description:
                                                          ...
                                                          └──Constructor argument type:
                                                             └──Type expr: Constructor: term
                                                                └──Type expr: Tuple
                                                                   └──Type expr: Variable: a12012
                                                                   └──Type expr: Variable: a12013
                                                          └──Constructor type:
                                                             └──Type expr: Constructor: term
                                                                └──Type expr: Variable: a11844
                                                       └──Pattern:
                                                    ...
                                                    └──Desc: Construct
                                                       └──Constructor description:
                                                          ...
                                                          └──Constructor argument type:
                                                             └──Type expr: Constructor: term
                                                                └──Type expr: Tuple
                                                                   └──Type expr: Variable: a12046
                                                                   └──Type expr: Variable: a12047
                                                          └──Constructor type:
                                                             └──Type expr: Constructor: term
                                                                └──Type expr: Variable: a11844
                                                       └──Pattern:
