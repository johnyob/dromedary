...
let%expect_test "function - identity" =
  ...
  [%expect
    {|
    Variables: a6569,a6569
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Variable: a6569
          └──Type expr: Variable: a6569
       └──Desc: Function
          └──Pattern:
             └──Type expr: Variable: a6569
  ...
  [%expect
    ...
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Arrow
             └──Type expr: Tuple
                └──Type expr: Variable: a6588
                └──Type expr: Variable: a6589
             └──Type expr: Variable: a6582
          └──Type expr: Arrow
             └──Type expr: Variable: a6588
             └──Type expr: Arrow
                └──Type expr: Variable: a6589
...
let%expect_test "function - uncurry" =
  ...
  [%expect
    {|
    Variables: a6598,a6608,a6605,a6605,a6608
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Arrow
             └──Type expr: Variable: a6608
             └──Type expr: Arrow
                └──Type expr: Variable: a6605
                └──Type expr: Variable: a6598
          └──Type expr: Arrow
             └──Type expr: Tuple
                └──Type expr: Variable: a6608
                └──Type expr: Variable: a6605
...
let%expect_test "function - compose" =
  ...
  [%expect
    ...
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Arrow
             └──Type expr: Variable: a6624
             └──Type expr: Variable: a6621
          └──Type expr: Arrow
             └──Type expr: Arrow
                └──Type expr: Variable: a6627
                └──Type expr: Variable: a6624
             └──Type expr: Arrow
                └──Type expr: Variable: a6627
                └──Type expr: Variable: a6621
...
let%expect_test "function - fst" =
  ...
  [%expect
    {|
    Variables: a6635,a6632,a6632
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Tuple
             └──Type expr: Variable: a6632
             └──Type expr: Variable: a6635
          └──Type expr: Variable: a6632
       └──Desc: Function
          └──Pattern:
             └──Type expr: Tuple
...
let%expect_test "function - snd" =
  ...
  [%expect
    {|
    Variables: a6641,a6645,a6641
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Tuple
             └──Type expr: Variable: a6645
             └──Type expr: Variable: a6641
          └──Type expr: Variable: a6641
       └──Desc: Function
          └──Pattern:
             └──Type expr: Tuple
...
let%expect_test "function - hd" =
  ...
  [%expect
    {|
    Variables: a6650,a6650
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Constructor: list
             └──Type expr: Variable: a6653
          └──Type expr: Variable: a6650
       └──Desc: Function
          └──Pattern:
             └──Type expr: Constructor: list
                └──Type expr: Variable: a6653
...
let%expect_test "annotation - identity" =
  ...
  [%expect
    {|
    Variables: a6668,a6668,a6668
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Variable: a6668
          └──Type expr: Variable: a6668
       └──Desc: Function
          └──Pattern:
             └──Type expr: Variable: a6668
...
let%expect_test "annotation - identity" =
  ...
  [%expect
    ...
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Variable: a6682
          └──Type expr: Variable: a6682
       └──Desc: Function
          └──Pattern:
             └──Type expr: Variable: a6677
             └──Desc: Variable: x
          └──Expression:
             └──Type expr: Variable: a6677
             └──Desc: Variable
       ...
       └──Desc: Let
          └──Value bindings:
             └──Value binding:
                └──Pattern:
                   └──Type expr: Arrow
                      └──Type expr: Variable: a6735
                      └──Type expr: Variable: a6735
                   └──Desc: Variable: id
                └──Abstraction:
                   └──Variables: a6735,a6735
                   └──Expression:
                      └──Type expr: Arrow
                         └──Type expr: Variable: a6735
                         └──Type expr: Variable: a6735
       ...
       └──Desc: Let rec
          └──Value bindings:
             └──Value binding:
                └──Variable: map
                └──Abstraction:
                   └──Variables: a6778,a6789
                   └──Expression:
                      └──Type expr: Arrow
                         └──Type expr: Arrow
                            └──Type expr: Variable: a6789
                            └──Type expr: Variable: a6778
                         └──Type expr: Arrow
                            └──Type expr: Constructor: list
                               └──Type expr: Variable: a6789
                            └──Type expr: Constructor: list
          ...
          └──Value bindings:
             └──Value binding:
                └──Pattern:
                   └──Type expr: Arrow
                      └──Type expr: Constructor: eq
                         └──Type expr: Variable: a7273
                         └──Type expr: Variable: a7274
                      └──Type expr: Arrow
          ...
          └──Value bindings:
             └──Value binding:
                └──Pattern:
                   └──Type expr: Arrow
                      └──Type expr: Tuple
                         └──Type expr: Variable: a7360
                         └──Type expr: Variable: a7363
                      └──Type expr: Variable: a7360
                   └──Desc: Variable: fst
                └──Abstraction:
                   └──Variables: a7363,a7360,a7360
                   └──Expression:
                      └──Type expr: Arrow
                         └──Type expr: Tuple
                            └──Type expr: Variable: a7360
                ...
                └──Value bindings:
                   └──Value binding:
                      └──Pattern:
                         └──Type expr: Arrow
                            └──Type expr: Tuple
                               └──Type expr: Variable: a7373
                               └──Type expr: Variable: a7369
                            └──Type expr: Variable: a7369
                         └──Desc: Variable: snd
                      └──Abstraction:
                         └──Variables: a7369,a7373,a7369
                         └──Expression:
                            └──Type expr: Arrow
                               └──Type expr: Tuple
                                  └──Type expr: Variable: a7373
                                                    ...
                                                    └──Desc: Construct
                                                       └──Constructor description:
                                                          ...
                                                          └──Constructor argument type:
                                                             └──Type expr: Tuple
                                                                └──Type expr: Constructor: term
                                                                   └──Type expr: Variable: a7525
                                                                └──Type expr: Constructor: term
                                                                   └──Type expr: Variable: a7523
                                                          └──Constructor type:
                                                             └──Type expr: Constructor: term
                                                                └──Type expr: Variable: a7397
                                                       └──Pattern:
                                                    ...
                                                    └──Desc: Construct
                                                       └──Constructor description:
                                                          ...
                                                          └──Constructor argument type:
                                                             └──Type expr: Constructor: term
                                                                └──Type expr: Tuple
                                                                   └──Type expr: Variable: a7565
                                                                   └──Type expr: Variable: a7566
                                                          └──Constructor type:
                                                             └──Type expr: Constructor: term
                                                                └──Type expr: Variable: a7397
                                                       └──Pattern:
                                                    ...
                                                    └──Desc: Construct
                                                       └──Constructor description:
                                                          ...
                                                          └──Constructor argument type:
                                                             └──Type expr: Constructor: term
                                                                └──Type expr: Tuple
                                                                   └──Type expr: Variable: a7599
                                                                   └──Type expr: Variable: a7600
                                                          └──Constructor type:
                                                             └──Type expr: Constructor: term
                                                                └──Type expr: Variable: a7397
                                                       └──Pattern:
