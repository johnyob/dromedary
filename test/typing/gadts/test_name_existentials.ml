                         ...
                         └──Pattern:
                            ...
                            └──Desc: Construct
                               └──Constructor description:
                                  ...
                                  └──Constructor argument type:
                                     └──Type expr: Tuple
                                        └──Type expr: Variable: a6753
                                        └──Type expr: Arrow
                                           └──Type expr: Variable: a6753
                                           └──Type expr: Constructor: list
                                              └──Type expr: Variable: a6755
                                  └──Constructor type:
                                     └──Type expr: Constructor: u
                               └──Pattern:
                                  └──Type expr: Tuple
