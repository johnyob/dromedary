                         ...
                         └──Pattern:
                            ...
                            └──Desc: Construct
                               └──Constructor description:
                                  ...
                                  └──Constructor argument type:
                                     └──Type expr: Tuple
                                        └──Type expr: Variable: a9061
                                        └──Type expr: Arrow
                                           └──Type expr: Variable: a9061
                                           └──Type expr: Constructor: list
                                              └──Type expr: Variable: a9063
                                  └──Constructor type:
                                     └──Type expr: Constructor: u
                               └──Pattern:
                                  └──Type expr: Tuple
