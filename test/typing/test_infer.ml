...
let%expect_test "annotation - identity" =
  ...
  [%expect
    {|
    Variables: α134,α134,α134
    Expression:
    └──Expression:
       └──Type expr: Arrow
          └──Type expr: Variable: α134
          └──Type expr: Variable: α134
       └──Desc: Function
          └──Pattern:
             └──Type expr: Variable: α134
             ...
             └──Value binding:
                ...
                └──Abstraction:
                   ...
                   └──Expression:
                      └──Type expr: Arrow
                         └──Type expr: Arrow
                            └──Type expr: Variable: α220
                            └──Type expr: Variable: α204
                         └──Type expr: Arrow
                            └──Type expr: Constructor: list
                               └──Type expr: Variable: α220
                            └──Type expr: Constructor: list
          ...
          └──Value bindings:
             └──Value binding:
                └──Pattern:
                   └──Type expr: Arrow
                      └──Type expr: Tuple
                         └──Type expr: Variable: α638
                         └──Type expr: Variable: α640
                      └──Type expr: Variable: α638
                   └──Desc: Variable: fst
                └──Abstraction:
                   └──Variables: α640,α638,α638
                   └──Expression:
                      └──Type expr: Arrow
                         └──Type expr: Tuple
                            └──Type expr: Variable: α638
                      ...
                      └──Pattern:
                         └──Type expr: Arrow
                            └──Type expr: Tuple
                               ...
                               └──Type expr: Variable: α645
                            └──Type expr: Variable: α645
                         └──Desc: Variable: snd
                      └──Abstraction:
                         └──Variables: α645,α648,α645
                         └──Expression:
                            └──Type expr: Arrow
                               └──Type expr: Tuple
                                  └──Type expr: Variable: α648
                                                    ...
                                                    └──Desc: Construct
                                                       └──Constructor description:
                                                          ...
                                                          └──Constructor argument type:
                                                             └──Type expr: Tuple
                                                                └──Type expr: Constructor: term
                                                                   └──Type expr: Variable: α747
                                                                └──Type expr: Constructor: term
                                                                   └──Type expr: Variable: α749
                                                          └──Constructor type:
                                                             └──Type expr: Constructor: term
                                                                └──Type expr: Variable: α664
                                                       └──Pattern:
                                                    ...
                                                    └──Desc: Construct
                                                       └──Constructor description:
                                                          ...
                                                          └──Constructor argument type:
                                                             └──Type expr: Constructor: term
                                                                └──Type expr: Tuple
                                                                   └──Type expr: Variable: α782
                                                                   └──Type expr: Variable: α783
                                                          └──Constructor type:
                                                             └──Type expr: Constructor: term
                                                                └──Type expr: Variable: α664
                                                       └──Pattern:
